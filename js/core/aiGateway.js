/* =========================================
   ASTRA AI GATEWAY v2.7
   Coach + trading system + market session memory
========================================= */
const AIGateway={
    extractAnswer(data){
    ...
    async ask(userMessage,extra={}){
        ...
        const api=ASTRA.modules.api;if(!api?.status?.().configured){console.log("AI PAYLOAD",payload);AstraReply("AI Gateway ready. Configure ASTRA.modules.api first.");return{configured:false,payload};}
...
ASTRA.registerModule("ai",AIGateway);console.log("ASTRA AI Gateway v2.7 Loaded");
